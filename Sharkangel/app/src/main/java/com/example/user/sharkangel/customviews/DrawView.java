...
public class DrawView extends View {
    ...
    private void init(Context context) {
        ...
        colorballs.add(0,new ColorBall(context, R.drawable.dot2, point1,0));
        colorballs.add(1,new ColorBall(context, R.drawable.dot2, point2,1));
        colorballs.add(2,new ColorBall(context, R.drawable.dot2, point3,2));
        colorballs.add(3,new ColorBall(context, R.drawable.dot2, point4,3));
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (groupId == 1) {
            canvas.drawRect(point1.x + colorballs.get(0).getWidthOfBall() / 2,
                            ...
                            point1.y + colorballs.get(0).getWidthOfBall() / 2, paint);
        } else {
